...
a_range=5
fold=5
[s,a]=DiPCA_cv(X_train,s_range,a_range,fold)# Cross-validation to select the number of principal components
P,W,Theta,Ps,lambda_s,PHI_v,phi_v_lim,Ts2_lim ,Qs_lim = DiPCA(X_train, s, a);# Modeling
phi_v_index,Ts_index,Qs_index = DiPCA_test(X_test, P, W, Theta, Ps, s, lambda_s, PHI_v);# Testing
DiPCA_visualization(phi_v_index,Ts_index,Qs_index,phi_v_lim,Ts2_lim,Qs_lim);# Visualization of monitoring results
